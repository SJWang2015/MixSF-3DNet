...
import numpy as np  
from util_occ import * 
import time

scale = 1.0
# occ_threshold = 0.80
share_channel = 1
use_voxel_mixer=False
nn_upsample = False
pwc_cv = False
occ_net = False
share_planes = 1
...
class UpsampleFlow(nn.Module):
    def forward(self, xyz, sparse_xyz, sparse_flow):
        ...
        sparse_flow = sparse_flow.permute(0, 2, 1).contiguous() # B S 3
...
class OccAwareNet(nn.Module):
    def __init__(self):
        ...
        self.sa1 = PointNetSetAbstraction(npoint=1024, radius=0.5, nsample=16, in_channel=32, mlp=[32,32,64], group_all=False)
        ...
        self.cv3 = SceneFlowRegressor(nsample=32, in_channel=256, sfeat_channel=256, sf_channel=0, mid_channel=128, share_channel=share_channel, out_channel=128, channels =[256, 256], mlp=[256])

        self.su_sa2 = PointNetSetUpConv(nsample=16, radius=1.2, f1_channel = 128, f2_channel = 256, mlp=[128, 128], mlp2=[128, 128])
        ...
        self.cv2 = SceneFlowRegressor(nsample=32, in_channel=128+64, sfeat_channel=128,  sf_channel=3,mid_channel=128, share_channel=share_channel, out_channel=128, channels=[128,128], mlp=[128, 128])
       
        self.su_sa1 = PointNetSetUpConv(nsample=16, radius=0.6, f1_channel = 64, f2_channel = 128, mlp=[64, 64], mlp2=[64, 64])
        ...
        self.cv1 = SceneFlowRegressor(nsample=16, in_channel=64+32, sfeat_channel=64,  sf_channel=3, mid_channel=64, share_channel=share_channel, out_channel=64, channels=[64,64], mlp=[64, 64])
        
        self.su_sa0 = PointNetSetUpConv(nsample=16, radius=0.6, f1_channel = 32, f2_channel = 64, mlp=[64, 64], mlp2=[64, 64])
        ...
        self.cv0 = SceneFlowRegressor(nsample=16, in_channel=64+32, sfeat_channel=64, sf_channel=3, mid_channel=64, share_channel=share_channel, out_channel=64, channels=[64,64], mlp=[64, 64])
    ...
    def forward(self, pc1, pc2, feats1=None, feats2=None):        
        ...
        up_feat1_l2 = self.su_sa2(pc1_l2, pc1_l3, feat1_l2, up_feat1_l3)
        up_feat2_l2 = self.su_sa2(pc2_l2, pc2_l3, feat2_l2, up_feat2_l3)
        ...
        c_feat_fwd_l2, c_feat_bwd_l2, flow_feat_l2, flow_l2 = self.cv2([pc1_l2, c_feat_fwd_l3_2, ind1_l2], [pc2_l2, c_feat_bwd_l3_2, ind2_l2], up_flow_l3_2, up_flow_feat_l3_2)

        up_feat1_l1 = self.su_sa1(pc1_l1, pc1_l2, feat1_l1, up_feat1_l2)
        up_feat2_l1 = self.su_sa1(pc2_l1, pc2_l2, feat2_l1, up_feat2_l2)
        ...
        c_feat_fwd_l1, c_feat_bwd_l1, flow_feat_l1, flow_l1 = self.cv1([pc1_l1, c_feat_fwd_l2_1, ind1_l1], [pc2_l1, c_feat_bwd_l2_1, ind2_l1],  up_flow_l2_1, up_flow_feat_l2_1)

        up_feat1_l0 = self.su_sa0(n_pc1, pc1_l1, feat1_l0, up_feat1_l1)
        up_feat2_l0 = self.su_sa0(n_pc2, pc2_l1, feat2_l0, up_feat2_l1)
        ...
        _, _, _, flow_l0  = self.cv0([n_pc1, c_feat_fwd_l1_0, ind1], [n_pc2, c_feat_bwd_l1_0, ind2], up_flow_l1_0, up_flow_feat_l1_0)
        ...
        if N > 4096:
            ...
            # return [rf_flow_l0, rf_flow_l1], [flow_l0, flow_l1, flow_l2, flow_l3], [fps_idx_l1, fps_idx_l2, fps_idx_l3]
            return [flow_l0, flow_l1], [flow_l0, flow_l1, flow_l2, flow_l3], [fps_idx_l1, fps_idx_l2, fps_idx_l3]
        

def multiScaleLoss(pred_rf_flows, pred_flows, gt_flow, gt_occ_masks, fps_idxs, alpha=[0.02, 0.04, 0.08, 0.16], beta=[0.02, 0.04], occ_threshold=0.5):
    # num of scale
...
if __name__ == '__main__':
    ...
    sf_label = torch.randn((2,3,2048)).cuda()
    occ_label = torch.randn((2,1,2048)).cuda()
